                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="col-12 mb-5">
                                <div class="row bg-dark bg-opacity-10 p-4">
                                    <div class="col-12 d-flex justify-content-center">

                                        <form class="col-12 col-md-6 col-lg-5 d-flex" role="search">
                                            <input class="cartSearch form-control me-2" type="search" placeholder="Search Product"
                                                aria-label="Search">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="offset-md-4 col-12 col-md-4 col-lg-4 mb-4 d-grid">
                                                <a href="home.php" class="btn btn-danger fs-4 fw-bold">
                                                    Back to Home
                                                </a>
                                            </div>
                                        </div>
